...
import java.util.*;
import java.text.*;
class BECKY extends First_Checking{
    ...
    public static void main(String args[])throws IOException, InterruptedException{
        ...
        do{
            ...
            if(original_question.equals("#date&time#")==true){
                ...
                System.out.println();
                Thread.sleep(2500);
                System.out.print(" BECKY : "+ft.format(date));
                System.out.println();
            }
            if((country_question(user_question)==true)&&(original_question.equals("#date&time#")==false)){
                ...
                if((capital_name.equals("INVALID")==true)){
                    System.out.println();
                    Thread.sleep(2500);
                    System.out.print(" BECKY : Invalid country name!");
                    System.out.println();
                }
                else{
                    System.out.println();
                    Thread.sleep(2500);
                    System.out.print(" BECKY : "+capital_name+".");
                    System.out.println();
                }
            }
            if((user_question.equals("do you remember me")==true)&&(original_question.equals("#date&time#")==false)){
                if(memory(user_name)==true){
                    System.out.println();
                    Thread.sleep(2500);
                    System.out.print(" BECKY : Yes! I remember you. We have chatted before.");
                    System.out.println();
                }
                else{
                    System.out.println();
                    Thread.sleep(2500);
                    System.out.print(" BECKY : No. We have not chatted before.");
                    System.out.println();
                }
            }
            if((hello_question(user_question)==true)&&(user_question.equals("do you remember me")==false)&&(original_question.equals("#date&time#")==false)){
                System.out.println();
                Thread.sleep(2500);
                System.out.print(" BECKY : Hello, "+user_name+".");
                System.out.println();
            }
