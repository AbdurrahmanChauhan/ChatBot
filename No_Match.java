...
class No_Match extends Countries_Capitals{
    protected static void no_match(String user_question,String original_question,String user_name)throws IOException, InterruptedException{
        System.out.println();
        Thread.sleep(2500);
        System.out.print(" BECKY : Could you please rephrase your statement. I have not understood it completely.");
        System.out.println();
        ...
        pw3.print(" BECKY : Could you please rephrase your statement. I have not understood it completely. ");
        pw3.println();
        pw3.println();
        pw1.close();
        pw2.close();
